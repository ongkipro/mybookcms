...
- [ ] **A-231** — Make the headless storefront report the payment methods the install actually offers.
...
- [ ] **A-233** — Resolve the ADR ids this product cites but has never recorded.
